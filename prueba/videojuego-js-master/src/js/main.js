...
var game = (function () {
    ...
    function preloadImages () {
        ...
        bgMain = new Image();
        bgMain.src = 'images/fondomundo.gif';
        bgBoss = new Image();
        bgBoss.src = 'images/fondomundo.gif';
    ...
    function Player(life, score) {
        ...
        player = new Image();
        player.src = 'images/nuevanave.png';
        player.posX = canvas.height - (player.height == 0 ? settings.defaultHeight : player.height) - settings.marginBottom;
        ...
        player.doAnything = function() {
            if (player.dead)
                return;
            if(keyPressed.top && player.posY > 5)
                 player.posY -= player.speed;
            if(keyPressed.down && player.posY > 5)
                 player.posY += player.speed;
